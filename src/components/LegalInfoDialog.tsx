              ...
              <div className="space-y-6 text-muted-foreground">
                <div>
                  ...
                  <p>
                    ...
                    </a>, and via usage data sent by self-hosted Lighthouse instances where somebody using that instance has consented to it (section 6).
                  </p>
                </div>
                ...
                <div>
                  <h2 className="text-lg font-semibold mb-2 text-foreground">6. Usage Data from Lighthouse Instances</h2>
                  <p className="mb-2">
                    Lighthouse is self-hosted: it runs on your own infrastructure, and we have no access to it. Separately from the website, a Lighthouse instance can send us a limited record of which parts of the product are used. This is off unless somebody using that instance switches it on, and it can be switched off again at any time.
                  </p>
                  <p className="mb-2">Where it is switched on, we receive:</p>
                  <ul className="list-disc list-inside space-y-1 ml-4 mb-2">
                    <li>A random identifier generated by your own Lighthouse for the browser that agreed. It is derived from nothing about you, your organisation or your licence, and is the only identifier we receive.</li>
                    <li>The name of the action taken, chosen from a fixed list published in the Lighthouse documentation (for example, that a forecast was run by hand).</li>
                    <li>For actions on a Team or Portfolio page, which tab was opened — as an address this product publishes about itself, never one containing your identifiers.</li>
                    <li>Facts about the instance: the Lighthouse version, how it is deployed, which licence tier it runs, and whether authentication is switched on.</li>
                  </ul>
                  <p className="mb-2">
                    <strong>We do not receive any of your content.</strong> No work item titles, queries or descriptions; no team, portfolio or delivery names; no user names, email addresses or account identifiers; no free text of any kind; and no address your browser was at. The message carries no field capable of holding any of these.
                  </p>
                  <p className="mb-2">
                    <strong>Legal basis:</strong> your consent, Art. 6(1)(a) GDPR and the corresponding provisions of the Swiss FADP. Consent is given per browser and can be withdrawn at any time through the usage data indicator in the Lighthouse footer, with no effect on the lawfulness of what was sent beforehand. Withdrawal stops future sending; it does not erase what was already received, which is deleted on the retention period below.
                  </p>
                  <p className="mb-2">
                    <strong>Processor and location:</strong> PostHog, on its Cloud EU service, with data at rest in the EU, under a data processing agreement. That agreement permits processing outside the European Economic Area, including in the United States, under Standard Contractual Clauses. PostHog's data processing agreement is the authority on this, rather than our summary of it: <a href="https://posthog.com/dpa" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">posthog.com/dpa</a>.
                  </p>
                  <p className="mb-2">
                    <strong>Retention:</strong> one year, after which it is deleted by the processor.
                  </p>
                  <p>
                    <strong>What it cannot tell us:</strong> this data counts browsers, not installations or people. Nothing in it identifies which instance sent it, so two colleagues on the same Lighthouse are indistinguishable from two people at different companies. A full account of what is sent, what is never sent, and what is stored on your own server is published in the Lighthouse documentation.
                  </p>
                </div>

                <div>
                  <h2 className="text-lg font-semibold mb-2 text-foreground">7. Storage Period</h2>
                  <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <div>
                  <h2 className="text-lg font-semibold mb-2 text-foreground">8. Your Rights</h2>
                ...
                <div>
                  <h2 className="text-lg font-semibold mb-2 text-foreground">9. Data Security</h2>
                ...
                <div>
                  <h2 className="text-lg font-semibold mb-2 text-foreground">10. Changes to This Policy</h2>
